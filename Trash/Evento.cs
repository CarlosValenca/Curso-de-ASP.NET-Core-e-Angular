...
namespace Eventos.IO.Domain.Models
{
    public class Evento : Entity<Evento>
    {
                      ...
                      string nomeEmpresa)
        {
            ...
            // Exceptions são caras, depende do SO, este custo computacional deve ser levado em conta
            // Isto pode gerar problemas de performance, pois pode roubar memória do servidor
            // O ideal é evitar as exceptions sempre que necessário
            if (nome.Length < 3)
            ...
            // Isto impede da entidade ser criada de forma errada, como é uma única
            // excessão não irá onerar tanto o sistema
        ...
        /* Este método foi transferido para a classe Entity em Domain.Core
         * de modo a podermos validar não somente um Evento mas qualquer tipo
         * de objeto
