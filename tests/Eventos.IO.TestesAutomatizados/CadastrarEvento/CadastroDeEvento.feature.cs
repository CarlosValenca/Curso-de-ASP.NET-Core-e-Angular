...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Registro de Novo Evento", null, new string[] {
...
#line hidden
            ...
            table1.AddRow(new string[] {
                        "categoriaId",
                        "ac381ba8-c187-482c-a5cb-899ad7176137"});
            table1.AddRow(new string[] {
